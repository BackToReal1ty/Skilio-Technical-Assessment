    ...
    getTask: function(callback) {
        ...
        dbConn.connect(function(err) {
            if (err) {
                ...
                const sql = "SELECT taskid, task, description, photo, date FROM task;";
    ...
    createTask: function(content, callback) {
        ...
        dbConn.connect(function(err) {
            if (err) {
                ...
                if (content.photo) {
                    const sql = "INSERT INTO task(task, description, photo) VALUES(?, ?, ?)";
                    dbConn.query(sql, [content.task, content.description, content.photo], (error, results) => {
                        dbConn.end();
                        if (error) {
                    ...
                    const sql = "INSERT INTO task(task, description) VALUES(?, ?)";
                    dbConn.query(sql, [content.task, content.description], (error, results) => {
                        dbConn.end();
                        if (error) {
                            console.log("[CREATETASK] Error!", error);
                            return callback(error, null);
